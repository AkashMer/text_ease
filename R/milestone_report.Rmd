...
```{r countData, cache=TRUE, comment=""}
...
<div class = "blue">
```{r unnestSentences, cache=TRUE, dependson="readData"}
...
```{r sampleData, cache=TRUE, dependson=c("readData", "unnestSentences")}
set.seed(75168)
...
```{r combineData, cache=TRUE, dependson=c("readData", "unnestSentences", "sampledata")}
...
```{r getTokens, cache=TRUE, dependson=c("readData", "unnsetSentences", "sampleData", "combineData")}
...
```{r checkMissing, cache=TRUE, dependson=c("readData", "unnsetSentences", "sampleData", "combineData", "getTokens")}
...
```{r removeMissing, cache=TRUE, dependson=c("readData", "unnsetSentences", "sampleData", "combineData", "getTokens")}
...
```{r combineNgrams, cache=TRUE, dependson=c("readData", "unnsetSentences", "sampleData", "combineData", "getTokens", "removeMissing")}
...
```{r dataSplit, cache=TRUE, dependson=c("readData", "unnsetSentences", "sampleData", "combineData", "getTokens", "removeMissing", "combineNgrams")}
...
```{r fig1, cache=TRUE, dependson=c("readData", "unnsetSentences", "sampleData", "combineData", "getTokens", "removeMissing", "combineNgrams", "dataSplit"), fig.height=30, fig.width=40, fig.cap="Unique n-grams by n-gram order"}
...
```{r fig2, cache=TRUE, dependson=c("readData", "unnsetSentences", "sampleData", "combineData", "getTokens", "removeMissing", "combineNgrams", "dataSplit", "fig1"), fig.height=40, fig.width=40, fig.cap="Unique N-gram Count Distribution"}
library(ggplot2)
...
```{r fig3, cache=TRUE, dependson=c("readData", "unnsetSentences", "sampleData", "combineData", "getTokens", "removeMissing", "combineNgrams", "dataSplit", "fig1"), fig.height=60, fig.width=50, fig.cap="10 Most and 10 Least Frequent N-grams"}
...
```{r fig4, cache=TRUE, dependson=c("readData", "unnsetSentences", "sampleData", "combineData", "getTokens", "removeMissing", "combineNgrams", "dataSplit"), fig.height=40, fig.width=60, fig.cap="Correlation of unique words used in all 3 sources with numbers and punctuation"}
...
```{r corrWithNumbPunc, cache=TRUE, comment = "", dependson=c("readData", "unnsetSentences", "sampleData", "combineData", "getTokens", "removeMissing", "combineNgrams", "dataSplit", "fig4")}
...
```{r fig5, cache=TRUE, dependson=c("readData", "unnsetSentences", "sampleData", "combineData", "getTokens", "removeMissing", "combineNgrams", "dataSplit"), fig.height=40, fig.width=60, , fig.cap="Correlation of unique words used in all 3 sources without numbers and punctuation"}
...
```{r corrWithoutNumbPunc, cache=TRUE, comment = "", dependson=c("readData", "unnsetSentences", "sampleData", "combineData", "getTokens", "removeMissing", "combineNgrams", "dataSplit", "fig5")}
# Correlation between twitter and blogs
corr1 <- cor.test(data = frequency[frequency$source == "blogs",],
         ~ proportion + twitter)
...
```{r finalProcessing, echo = FALSE, cache=TRUE, dependson=c("readData", "unnsetSentences", "sampleData", "combineData")}
...
```{r fig6, cache=TRUE, dependson=c("readData", "unnsetSentences", "sampleData", "combineData", "finalProcessing"), fig.height=40, fig.width=60, fig.cap="Markov chains of bi-grams from train data set"}
...
* **bookdown** : *Version `r packageVersion("bookdown")`*
* **R.utils** : *Version `r packageVersion("R.utils")`*
* **readr** : *Version `r packageVersion("readr")`*
* **dplyr** : *Version `r packageVersion("dplyr")`*
* **tidytext** : *Version `r packageVersion("tidytext")`*
* **tidymodels** : *Version `r packageVersion("tidymodels")`*
...
* **ggraph** : *Version `r packageVersion("ggraph")`*  
* **grid** : *Version `r packageVersion("grid")`*
